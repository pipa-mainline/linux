...
#define AW88261_OCDS_OC_VALUE (AW88261_OCDS_OC << AW88261_OCDS_START_BIT)

#define AW88261_OTHS_START_BIT (1)
#define AW88261_OTHS_OT (1)
#define AW88261_OTHS_OT_VALUE (AW88261_OTHS_OT << AW88261_OTHS_START_BIT)
...
#define AW88261_BIT_PLL_CHECK \
	(AW88261_CLKS_STABLE_VALUE | AW88261_PLLS_LOCKED_VALUE)

#define AW88261_BIT_SYSST_CHECK_MASK                                       \
	(~(AW88261_UVLS_NORMAL_VALUE | AW88261_BSTOCS_OVER_CURRENT_VALUE | \
	   AW88261_BSTS_FINISHED_VALUE | AW88261_SWS_SWITCHING_VALUE |     \
	   AW88261_NOCLKS_NO_CLOCK_VALUE | AW88261_CLKS_STABLE_VALUE |     \
	   AW88261_OCDS_OC_VALUE | AW88261_OTHS_OT_VALUE |                 \
...
#define AW88261_ULS_HMUTE_MASK                     \
	(~(((1 << AW88261_ULS_HMUTE_BITS_LEN) - 1) \
	   << AW88261_ULS_HMUTE_START_BIT))
...
#define AW88261_BST_OS_WIDTH_MASK                     \
	(~(((1 << AW88261_BST_OS_WIDTH_BITS_LEN) - 1) \
	   << AW88261_BST_OS_WIDTH_START_BIT))
...
#define AW88261_BST_LOOPR_MASK                     \
	(~(((1 << AW88261_BST_LOOPR_BITS_LEN) - 1) \
	   << AW88261_BST_LOOPR_START_BIT))
...
#define AW88261_RSQN_DLY_MASK                     \
	(~(((1 << AW88261_RSQN_DLY_BITS_LEN) - 1) \
	   << AW88261_RSQN_DLY_START_BIT))
...
#define AW88261_BURST_SSMODE_MASK                     \
	(~(((1 << AW88261_BURST_SSMODE_BITS_LEN) - 1) \
	   << AW88261_BURST_SSMODE_START_BIT))
...
#define AW88261_BST_BURST_MASK                     \
	(~(((1 << AW88261_BST_BURST_BITS_LEN) - 1) \
	   << AW88261_BST_BURST_START_BIT))
...
#define AW88261_EF_ISN_GESLP_H_MASK                     \
	(~(((1 << AW88261_EF_ISN_GESLP_H_BITS_LEN) - 1) \
	   << AW88261_EF_ISN_GESLP_H_START_BIT))

#define AW88261_EF_ISN_GESLP_L_START_BIT (0)
#define AW88261_EF_ISN_GESLP_L_BITS_LEN (10)
#define AW88261_EF_ISN_GESLP_L_MASK                     \
	(~(((1 << AW88261_EF_ISN_GESLP_L_BITS_LEN) - 1) \
	   << AW88261_EF_ISN_GESLP_L_START_BIT))
...
#define AW88261_RATES (SNDRV_PCM_RATE_8000_48000 | SNDRV_PCM_RATE_96000)
...
#define REG_VAL_TO_DB(value)                                             \
	((((value) >> AW88261_VOL_6DB_START) * AW88261_VOLUME_STEP_DB) + \
